...
test(`Test to learn CSS Selectors`, async ({ page }) => { 
   ...
   // await page.locator(`//a[@title='Leads' and @class='slds-context-bar__label-action dndItem']`).click()
    ...
    await page.locator(`//button[@name='salutation']`).click() //click on the Salutation dropdown 
    await page.locator(`//span[text()='Mr.']`).click(); //click on the value slected in the dropdown 
